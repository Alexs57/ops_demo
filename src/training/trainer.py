...
def evaluate_with_tta(
    ...
    *,
    ...
    Args:
        ...
        y: (N,) labels.
        mask_aware: True if model expects 2C-channel input [X⊙M, M] (mask-aware variant).
    ...
    averaged across the K views before argmax. This converts the two-view train-
...
def train_classifier_two_view(
    ...
    *,
    ...
    consistency_mode="symmetric" (R-Drop-style; a symmetric two-view
    baseline). Both views are expected to come from the same mask
    distribution. Loss:
